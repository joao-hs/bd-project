...
create table tem_categoria (ean numeric(13) not null, categoria_simples_nome varchar(80) not null, constraint fk_tem_categoria_produto foreign key(ean) references produto(ean), constraint fk_tem_categoria_categoria foreign key(categoria_simples_nome) references categoria_simples(categoria_simples_nome));
